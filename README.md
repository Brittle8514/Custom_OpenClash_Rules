...
<p align="center">
 <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/Brittle8514/Custom_OpenClash_Rules?style=flat">
 <img alt="GitHub contributors" src="https://img.shields.io/github/contributors-anon/Brittle8514/Custom_OpenClash_Rules?style=flat">
 <img alt="GitHub commit activity" src="https://img.shields.io/github/commit-activity/t/Brittle8514/Custom_OpenClash_Rules?style=flat">
...
按照本项目的 [Wiki](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki) 中的设置方案，搭配本项目的[订阅转换模板](https://raw.githubusercontent.com/Brittle8514/Custom_OpenClash_Rules/main/cfg/Custom_Clash.ini)，花费数分钟对 OpenClash 进行设置，无需套娃其他工具，仅依靠 OpenClash 自身即可实现更稳健的 DNS 策略与分流功能，同时配合 Dnsmasq 可实现无需第三方插件的广告拦截，并且完美兼容 IPv6。
...
**按照本项目 [Wiki](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki) 中的设置方案，配合本项目的订阅转换模板对 OpenClash 进行配置，即可实现以下特性，更优雅地使用你的 OpenClash：**
...
请按照本项目 Wiki 中的对应部分对 OpenClash 进行设置：[OpenClash-设置方案](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki/OpenClash-设置方案)
...
具体个性化实现方式，请参考 Wiki 中的对应章节：[个性化需求](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki/其他说明#关于个性化需求)
...
~~具体设置见 Wiki 中的方案：[广告拦截设置方案](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki/无插件广告拦截功能设置方案)~~
...
OpenWrt 的 IPv6 设置方案见本项目的 Wiki：[OpenWrt-IPv6-设置方案](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki/OpenWrt-IPv6-设置方案)

---

### ❓ 不能上网？分流不正常？某些网站打不开？OpenClash 不能启动？

出现故障请参考 [Wiki 中的故障排除部分](https://github.com/Brittle8514/Custom_OpenClash_Rules/wiki/故障排除)，内含常见问题的解决方法。
...
<a href="https://github.com/Aethersailor/Custom_OpenClash_Rules/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Brittle8514/Custom_OpenClash_Rules&anon=1" alt="贡献者列表" /></a>
