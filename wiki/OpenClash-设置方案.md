...
> 个人观点：[关于旁路由的一些吐槽](6.关于“旁路由”的一些吐槽)
...
🔗 [OpenWrt IPv6 设置方案](2.OpenWrt-IPv6-设置方案)
...
![SmartDNS 延迟对比](./doc/openwrt/smartdns.png)
...
>
> 具体本项目 Wiki 中的方案：[广告拦截设置方法](4.无插件广告拦截功能设置方案)
...
![dns劫持](./doc/openclash/pics/3.png)
...
具体参考：[BT 和 PT 等下载流量分流问题](5.故障排除#bt-和-pt-等下载流量分流问题)

你也可以通过该功能，自己补充自定义规则，指定某些域名直连或代理，以及指定局域网内某些直连或代理等等。

[如何添加自定义规则](5.故障排除#如何添加自定义规则)
